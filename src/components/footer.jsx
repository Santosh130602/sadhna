...
const Footer = () => {
  return (
    <div className="bg-[#2D2A62] py-12 text-white" >
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 md:space-x-8 text-center md:text-left">
        ...
        <div className="relative md:w-1/2 max-w-lg w-full">
          ...
          <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 text-white px-6 py-2 rounded-full flex items-center gap-2 hover:bg-orange-600 transition-colors">
