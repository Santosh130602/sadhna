    ...
    <section className="bg-white py-4">
      <div className="container mx-auto flex flex-col md:flex-row justify-around items-center">
        ...
        <div className="flex gap-6 items-center mb-4 md:mb-0">
          <div>
          <Link to="/" >
          <img src={Logo} alt="India Think Council Logo" className="h-24 " />
              {/* <img src={Logo} className="h-20 w-20 p-2 ml-10" alt="Logo" /> */}
            </Link>
          </div>
          <div>
          <h1 className="text-lg font-bold">SADHANASHRI KUTUMB  </h1>
          <p className="text-xs text-blue-600">Dharm | Sanskriti | Nation</p>
        ...
        <div className="text-center">
          <h1 className="text-lg font-bold">साधनाश्री कुटुम्ब </h1>
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div>
            <a href="/donate" className="bg-red-600 text-white px-4 py-2 rounded">
              CONTRIBUTE NOW
            </a>
          </div>
        </div>
