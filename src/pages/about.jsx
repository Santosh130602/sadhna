...
//             </p> */}
//             <p>*परिचय*:- साधनाश्री कुटुम्ब की स्थापना भगवद्‌पाद शिव अवतार आदिशंकराचार्य भगवान के पावन प्राकट्य दिवस वैशाष शुक्ल पंचमी, विक्रमी संवत 2077 ( तदनुसार (28 अप्रैल 2020) के पावन पर्व पर एक पवित्र संकल्प के साथ हुआ । साधनाश्री कुटुम्ब का उद्देश्य सत्य सनातन धर्म,संस्कृति,राष्ट्र को उसका मूल सौष्ठव प्रदान करना,जिससे कि स्वच्छ,सुन्दर,स्वस्थ्य,समृध्द,संस्कारी,ज्ञानशील युक्त मार्गदर्शक समाज का निर्माण हो सके। भारत और भारतीयता के पुनर्जागरण के लिए साधनाश्री कुटुम्ब संकल्पबद्ध है। साधनाश्री कुटुम्ब अपने संकल्प पूर्ति के लिए तीन प्रमुख आयाम निर्धारित किये है।
...
//           <div className="text-gray-800 space-y-6 text-lg" style={{ fontFamily: 'Kalam, cursive' }}   >
//             <h1 className='text-5xl font-thin'>*परिचय*</h1>
//             <p className='text-xl'> 
//                साधनाश्री कुटुम्ब की स्थापना भगवद्‌पाद शिव अवतार आदिशंकराचार्य भगवान के पावन प्राकट्य दिवस वैशाष शुक्ल पंचमी, विक्रमी संवत 2077 ( तदनुसार 28 अप्रैल 2020) के पावन पर्व पर एक पवित्र संकल्प के साथ हुआ। साधनाश्री कुटुम्ब का उद्देश्य सत्य सनातन धर्म,संस्कृति,राष्ट्र को उसका मूल सौष्ठव प्रदान करना,जिससे कि स्वच्छ,सुन्दर,स्वस्थ्य,समृध्द,संस्कारी,ज्ञानशील युक्त मार्गदर्शक समाज का निर्माण हो सके। भारत और भारतीयता के पुनर्जागरण के लिए साधनाश्री कुटुम्ब संकल्पबद्ध है। साधनाश्री कुटुम्ब अपने संकल्प पूर्ति के लिए तीन प्रमुख आयाम निर्धारित किये हैं।
//             </p>
//             <ul className="space-y-2 text-2xl">
//               <li>• गुरुकुल Gurukul</li>
//               <li>• गोकुल Gokul</li>
//               <li>• देवकुल Devkul</li>
//             </ul>
//           </div>
...
//       {/* Main Content Section */}
//       <div className="bg-yellow-200 py-10">
//         <div className="bg-yellow-100 rounded-xl shadow-lg p-8 max-w-4xl mx-auto text-center relative z-10 " >
//           <div className="text-gray-800 space-y-6 text-lg" style={{ fontFamily: 'Kalam, cursive' }}>
//             <h1 className='text-5xl font-thin'>*परिचय*</h1>
//             <p className='text-xl'>
...
//   <div
//     className="relative flex flex-col md:flex-row items-center justify-between p-10 bg-yellow-200"
//     style={{
...
//     }}
//   >
//     <div className="w-1/2 mx-auto text-black-800 z-10 bg-opacity-80 p-8 rounded-md space-y-6" 
//          style={{ fontFamily: 'Kalam, cursive' }}>
//       <p className="text-xl">
//         अखंड मंडलाकार की अवधारणा से प्रेरित साधनाश्री कुटुम्ब का लक्ष्य है – भारत के सम्पूर्ण राष्ट्र का निर्माण करना, जो मृत्य से अमरता की ओर अग्रसर हो। हमारी आराधना का मुख्य ध्येय यह है कि सब सुखी हों और सभी को ‘सेवा’ का माध्यम बनाना हो।
//       </p>
//       <p className="text-xl">
//         यदि हम आवश्यक उपक्रमों के साथ कुशल संयोजन करके चराचर जगत के हर एक हिस्से को सहभागी बना सकें, तो हमारा भारत विश्वविजयी बन सकता है। इसका आधार हमारी आंतरिक शक्ति और आस्था पर टिका हुआ है।
//       </p>
//       <p className="text-xl">
//         साधनाश्री कुटुम्ब आधुनिकता और प्राचीनता के बीच निरंतरता का संयोजन करते हुए, पुरातन ज्ञान का आधुनिक संदर्भ में अनुकूलन करने की दिशा में प्रतिबद्ध है। 'गुरुकुल', 'गोकुल', और 'देवालय' के कुशल संचालन से ही हम अपने भारत को पुनः विश्वगुरु बना सकते हैं।
//       </p>
//     </div>
//   </div>
// </div>
...
// import backgroundImage from "../assets/hero9.jpeg"; // Path to your background image
// import deisti from "../assets/dristi.png";
// import FooterBackground from "../assets/bg.jpeg"; // Import the background image
...
//         <div
//           className="relative bg-cover bg-center mt-10 py-20"
//           style={{
...
//             <h2 className="text-4xl font-semibold">साधनाश्री कुटुम्ब</h2>
//             <p className="mt-4 text-lg">हमारा मिशन: समाज का उत्थान और जागरूकता फैलाना।</p>
//           </div>
//         </div>
//       </div>
//     </div>
...
// import backgroundImage from "../assets/hero9.jpeg"; // Path to your background image
// import deisti from "../assets/dristi.png";
// import FooterBackground from "../assets/bg6.jpeg"; // Import your footer background image
...
//       {/* Main Content Section with Background */}
//       <div className="bg-yellow-200 py-10" style={{
//             backgroundImage: `url(${FooterBackground})`, // Set the image as the background
//             backgroundPosition: 'center',
//             backgroundSize: 'cover',
...
//         <div className="bg-neutral-900 rounded-xl shadow-lg p-8 max-w-4xl mx-auto text-center relative z-10" >
//           <div className="text-gray-800 space-y-6 text-lg" style={{ fontFamily: 'Kalam, cursive' }}>
//             <h1 className='text-5xl font-thin'>*परिचय*</h1>
//             <p className='text-xl'>
//               साधनाश्री कुटुम्ब की स्थापना भगवद्पाद शिव अवतार आदिशंकराचार्य भगवान के पावन प्राकट्य दिवस वैशाख शुक्ल पंचमी, विक्रम संवत 2077 (28 अप्रैल 2020) के पावन पर्व पर एक पवित्र संकल्प के साथ हुआ। साधनाश्री कुटुम्ब का उद्देश्य सत्य सनातन धर्म, संस्कृति, राष्ट्र को उसका मूल सौष्ठव प्रदान करना है, जिससे कि स्वच्छ, सुंदर, स्वस्थ, समृद्ध, संस्कारी, ज्ञानशील युक्त मार्गदर्शक समाज का निर्माण हो सके। भारत और भारतीयता के पुनर्जागरण के लिए साधनाश्री कुटुम्ब संकल्पबद्ध है। साधनाश्री कुटुम्ब अपने संकल्प पूर्ति के लिए तीन प्रमुख आयाम निर्धारित किये हैं।
...
//             <p className='text-xl text-oragne-50'>
//               साधनाश्री कुटुम्ब की स्थापना भगवद्पाद शिव अवतार आदिशंकराचार्य भगवान के पावन प्राकट्य दिवस वैशाख शुक्ल पंचमी, विक्रम संवत 2077 (28 अप्रैल 2020) के पावन पर्व पर एक पवित्र संकल्प के साथ हुआ। साधनाश्री कुटुम्ब का उद्देश्य सत्य सनातन धर्म, संस्कृति, राष्ट्र को उसका मूल सौष्ठव प्रदान करना है, जिससे कि स्वच्छ, सुंदर, स्वस्थ, समृद्ध, संस्कारी, ज्ञानशील युक्त मार्गदर्शक समाज का निर्माण हो सके। भारत और भारतीयता के पुनर्जागरण के लिए साधनाश्री कुटुम्ब संकल्पबद्ध है। साधनाश्री कुटुम्ब अपने संकल्प पूर्ति के लिए तीन प्रमुख आयाम निर्धारित किये हैं।
//             </p>
//             <ul className="space-y-2 text-2xl">
//               <li>• गुरुकुल अभियान Gurukul Abhiyan</li>
